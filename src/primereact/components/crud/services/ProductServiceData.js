...
export const ProductServiceData = {
    ...
    getAxiosData(){
        const data = axios.get("http://localhost:3000/demo/data/products.json")
    ...
    getProducts() {
        console.log("ProductServiceData ::: getProducts");
        
        console.log(this.getAxiosData());
        //return Promise.resolve(this.getProductsData());
        return Promise.resolve(this.getAxiosData());
    },
